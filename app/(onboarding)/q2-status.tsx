...
export default function Q2Status() {
  ...
  return (
    ...
    >
      <SelectionCard emoji="🤰" title="My dog is pregnant" description="Puppies haven't arrived yet"
        selected={selected === 'pregnant'} onPress={() => setSelected('pregnant')} index={0} />
      <SelectionCard emoji="🐣" title="The puppies are already here" description="They've been born"
        selected={selected === 'born'} onPress={() => setSelected('born')} index={1} />
    </OnboardingScreen>
  );
}
